...
// import {
//   CameraCaptureView, CameraCaptureOptions
// } from "./camera-capture-view"
...
//         ),
//         new CameraCaptureView({fixAspectRatioToWidthOverHeight: 1, onExceptionEvent: this.options.onExceptionEvent}).with( cc => {
